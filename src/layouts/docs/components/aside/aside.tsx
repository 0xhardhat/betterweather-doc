                      ...
                      <Link href={slug} passHref>
                        <a
                          ...
                          className="
                            ...
                            aria-current-page:bg-gray-300
                            aria-current-page:text-[#239C79]

                            dark:aria-current-page:text-[#6ddaba]
                            dark:aria-current-page:bg-green-600/10
                          "
                        >
                          {title}
                        </a>
